...
public class CartController {
    ...
    @PostMapping
    public ResponseCart addCart(@RequestBody SignUpRequestCart cart){
        return cartService.addCart(cart);
    }

    @PutMapping("/{cartId}")
    public ResponseEntity<ResponseCart> updateCart(@PathVariable Long cartId, @RequestBody EditRequestCart cart){
